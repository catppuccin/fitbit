...
(function (TextureFormat) {
    ...
    TextureFormat[TextureFormat["ABGR4444"] = 34620484] = "ABGR4444";
...
var pixelEncoders = (_b = {},
    ...
    _b[TextureFormat.ABGR4444] = function (data, offset, output) {
        if (data[offset + 3] === 0) {
            output[0] = 0;
            output[1] = 0;
            return;
        }
        var r = rescaleColor(data[offset], 15);
        var g = rescaleColor(data[offset + 1], 15);
        var b = rescaleColor(data[offset + 2], 15);
        var a = rescaleColor(data[offset + 3], 15);
...
function findTextureFormat(outputFormat, rle) {
    ...
    switch (outputFormat) {
        ...
        case types_1.TXIOutputFormat.RGBA4444:
